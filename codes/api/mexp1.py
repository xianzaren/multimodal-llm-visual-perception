...
# 颜色映射表
'''color_map_configs = {
    'greyscale': {"name": "greyscale", "bottom_color": "black", "top_color": "white", "legend": "black to white"},
    'bodyheat': {"name": "bodyheat", "bottom_color": "black", "top_color": "white", "legend": "black to white"},
    "rainbow": {"name": "rainbow", "bottom_color": "purple", "top_color": "red", "legend": "purple to red"},
    "singlehue": {"name": "Blues_r", "bottom_color": "dark blue", "top_color": "pale blue", "legend": "dark blue to pale blue"},
    ...
    "extbodyheat": {"name": "extbodyheat", "bottom_color": "very dark purple", "top_color": "light yellow", "legend": "very dark purple to light yellow"},
    "spectral": {"name": "spectral", "bottom_color": "black", "top_color": "white", "legend": "black to white"},
}'''
    ...
    if os.path.isdir(subfolder_path):
        ...
        for input_image_path in png_paths:
            ...
            baselineprompt = (f"Find the a coordinate of the point with the value {value} in the scalar field image."
                             ...
                             f"Please ensure the output strictly follows this format.")
